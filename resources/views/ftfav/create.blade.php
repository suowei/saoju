        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">收藏《{{ $ft->title }}》并评论</div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" id="favoriteEdit" role="form" method="POST" action="{{ url('/ftfav2') }}">
                            {!! csrf_field() !!}
