            ...
            <div class="col-md-9">
                ...
                <div class="drama">
                    ...
                    @if($params['sort'] == 'release_date')
                        <strong>
                            @if($params['order'] == 'asc')
                                <a href="{{ $url.'sort=release_date&order=desc' }}">发表时间<span class="glyphicon glyphicon-arrow-up order-select"></span></a>
                            @else
                                <a href="{{ $url.'sort=release_date&order=asc' }}">发表时间<span class="glyphicon glyphicon-arrow-down order-select"></span></a>
                            @endif
                        </strong>
                    @else
                        <a href="{{ $url.'sort=release_date&order=asc' }}">发表时间<span class="glyphicon glyphicon-arrow-up order"></span></a>
                    @endif
                    &nbsp;&nbsp;
