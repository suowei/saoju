                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/episode') }}" onsubmit="this.submit.disabled=true;this.submit.innerHTML='处理中';">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" name="authorization" rows="10" placeholder="请填写剧组版权声明。版权声明中如有标注需取得剧组授权才可转载的，请在剧组版权声明后另附文字版授权说明，授权截图请用户自行保留。">{{ old('authorization') }}</textarea>
                                </div>
                            </div>
