...
@section('title', '2015听剧总结（按剧集评分排序） - ')
...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <h4 class="text-success">2015听剧总结（按我的剧集评分排序）</h4>
            ...
            <div class="col-md-3">
                <p class="text-danger">本页展示了2015年发布的分集中，您对其所属剧集标记过收藏的分集，不代表您收藏过该分集，如需按分集收藏查看，请点击下面的链接↓</p>
                <p><a href="{{ url('/user/episode2015') }}" class="btn btn-info btn-xs">按我的分集评分排序</a></p>
            </div>
        </div>
    </div>
@endsection
